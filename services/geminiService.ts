...
// Helper: Convert text to reading (Kana) for music generation - Japanese Only
...
// Helper: Generate structured lyrics using Gemini (better than Mureka's internal one)
