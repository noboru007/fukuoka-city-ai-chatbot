...
import { ExternalLinkIcon, PlayIcon, StopIcon, LoadingSpinnerIcon } from './Icons';
...
const Message: React.FC<MessageProps> = ({ role, content, sources, audioSegments, isGeneratingAudio, onGenerateAudio, language }) => {
    ...
    <div className={containerClasses}>
      ...
      <div className={`flex flex-col max-w-full ${isUser ? 'items-end' : 'items-start'}`}>
        ...
        {!isUser && (content && content.trim() !== '') && (
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1 mt-0 text-gray-400">
