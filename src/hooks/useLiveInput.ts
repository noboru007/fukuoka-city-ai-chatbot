    ...
    const startRecording = useCallback(async () => {
        ...
        try {
            ...
            try {
                ...
                console.error('[Recording] Ephemeral token failed:', error);
                throw new Error('Failed to obtain ephemeral token for voice input. Please try again.');
            }
            ...
            onError(error instanceof Error ? error.message : 'マイクへのアクセスが拒否されました。');
            setRecordingStatus('idle');
        }
